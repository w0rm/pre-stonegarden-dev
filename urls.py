urls=(
    ...
    "/a/blocks/new/?", "controllers.blocks.NewBlock",
    "/a/blocks/(\d+)(/|\.json)?", "controllers.blocks.GetBlock",
    "/a/blocks/?", "controllers.blocks.GetBlocks",
    "/a/blocks/(\d+)/edit/?", "controllers.blocks.EditBlock",
    ...
    "/a/blocks/(\d+)/delete/?", "controllers.blocks.DeleteBlock",
